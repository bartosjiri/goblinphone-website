<script lang="ts">
	...
	import { GOBLINGRLZ_URL } from '$constants/goblingirl/links';
	import { GOBLINGIRL_SPEECH } from '$constants/goblingirl/speech';
		...
		{#if speech}
			...
			>
				...
				<div class="background">
					<img src="/assets/images/goblingirl/speech-bubble.png" alt="" />
				</div>
			</div>
		{/if}
		<div class="container">
			<img
				class="mouth"
				class:--active={speech}
				src="/assets/images/goblingirl/girl-speech.png"
				alt=""
			/>
			<img src="/assets/images/goblingirl/girl.png" alt="" />
		</div>
	</a>
</div>
